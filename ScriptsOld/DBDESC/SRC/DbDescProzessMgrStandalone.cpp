...
/******************************************************************************************************************************************************************************************************************************
  ...
  ****************************************************************************************************************************************************************************************************************************/
   ...
   ***************************************************************************************************************************************************************************************************************************/
   ...
   {   DUAL         ,DUAL    ,"DUAL"      ,TAB             ,TAB               ,18        ,ADD_ZUSATZ_COL(""   ,_T(""))           ,NONE         ,DB_SYSTEM      ,0                                                   },
   {   USER         ,DUAL    ,"USER"      ,SQL_VARCHAR     ,SQL_C_CHAR        ,31        ,ADD_ZUSATZ_COL(""   ,_T(""))           ,NONE         ,0              ,0                                                   },
   {   SYSDATE      ,DUAL    ,"SYSDATE"   ,SQL_TIMESTAMP   ,SQL_C_TIMESTAMP   ,16        ,ADD_ZUSATZ_COL(""   ,_T(""))           ,NONE         ,0              ,0                                                   },
   {   ROWID        ,DUAL    ,"ROWID"     ,SQL_VARCHAR     ,SQL_C_CHAR        ,20        ,ADD_ZUSATZ_COL(""   ,_T(""))           ,NONE         ,DB_UNIQUEKEY   ,0                                                   },
